...
(function () {
    ...
    function addContact(contact) {
        ...
        theRow.find('button')
            .click(function () {
                $.post("http://localhost:8080/pcs/hw90/deleteContact.php", { id: contact.Id }, function () {
                    theRow.remove();
                }).fail(function (jqxhr) {
    ...
    addContactForm.on("submit", function (event) {
        ...
        $.post("http://localhost:8080/pcs/hw90/addContact.php", newContact, function () {
    ...
    $("#load").click(function () {
        $.get("http://localhost:8080/pcs/hw90/getContacts.php", function (loadedContactData) {
